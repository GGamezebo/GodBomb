...
const _SR: Dictionary = {
	...
	"SETTINGS_RESET_HINT": "Vrati podrazumevana podešavanja i imena igrača.",
	...
	"ACTION_HINT_TAP_TABLE": "Dodirni ekran — potez sledećeg",
	"TIME_PROGRESS_LABEL": "Do kraja igre",
	...
	"HUD_TABLE_CENTER_HINT": "Stavi telefon na sredinu stola",
...
const _ES: Dictionary = {
	...
	"SETTINGS_DIFFICULTY": "Dificultad: %s",
	...
	"SETTINGS_RESET_HINT": "Restaurar los ajustes y nombres predeterminados.",
	...
	"ACTION_HINT_TAP_TABLE": "Toca la pantalla — turno del siguiente",
	"TIME_PROGRESS_LABEL": "Hasta el final",
	"TIME_PROGRESS_MINUTES": "%d min",
	"HUD_LOTTERY": "Sorteo — ¿quién empieza?",
	"HUD_READY": "¿Listos?",
	"HUD_START_ROUND": "Iniciar ronda",
	"HUD_START_ROUND_HINT": "Toca «Iniciar ronda»",
	"HUD_TABLE_CENTER_HINT": "Pon el teléfono en el centro de la mesa",
...
const _HI: Dictionary = {
	...
	"SETTINGS_RESET_HINT": "डिफ़ॉल्ट सेटिंग्स और खिलाड़ी नाम पुनर्स्थापित करें।",
	...
	"ACTION_HINT_TAP_TABLE": "स्क्रीन टैप करें — अगले खिलाड़ी की बारी",
	"TIME_PROGRESS_LABEL": "खेल के अंत तक",
	"TIME_PROGRESS_MINUTES": "%d मिन",
	"HUD_LOTTERY": "लॉटरी — पहले कौन खेलेगा?",
	"HUD_READY": "तैयार?",
	"HUD_START_ROUND": "राउंड शुरू करें",
	"HUD_START_ROUND_HINT": "«राउंड शुरू करें» दबाएँ",
	"HUD_TABLE_CENTER_HINT": "फ़ोन को मेज़ के बीच में रखें",
...
const _DE: Dictionary = {
	...
	"SETTINGS_DIFFICULTY": "Schwierigkeit: %s",
	...
	"SETTINGS_RESET_HINT": "Standardeinstellungen und Spielernamen wiederherstellen.",
	...
	"ACTION_HINT_TAP_TABLE": "Bildschirm tippen — nächster Spieler",
	"TIME_PROGRESS_LABEL": "Bis zum Ende",
	"TIME_PROGRESS_MINUTES": "%d Min",
	"HUD_LOTTERY": "Los entscheidet — wer beginnt?",
	"HUD_READY": "Bereit?",
	"HUD_START_ROUND": "Runde starten",
	"HUD_START_ROUND_HINT": "Tippe «Runde starten»",
	"HUD_TABLE_CENTER_HINT": "Legt das Handy in die Tischmitte",
...
const _FR: Dictionary = {
	...
	"SETTINGS_DIFFICULTY": "Difficulté: %s",
	...
	"SETTINGS_RESET_HINT": "Restaurer les paramètres et noms par défaut.",
	...
	"ACTION_HINT_TAP_TABLE": "Touchez l'écran — tour suivant",
	"TIME_PROGRESS_LABEL": "Jusqu'à la fin",
	"TIME_PROGRESS_MINUTES": "%d min",
	"HUD_LOTTERY": "Tirage au sort — qui commence ?",
	"HUD_READY": "Prêts ?",
	"HUD_START_ROUND": "Démarrer la manche",
	"HUD_START_ROUND_HINT": "Touchez «Démarrer la manche»",
	"HUD_TABLE_CENTER_HINT": "Posez le téléphone au centre de la table",
...
const _IT: Dictionary = {
	...
	"SETTINGS_DIFFICULTY": "Difficoltà: %s",
	"SETTINGS_DIFFICULTY_EASY": "Facile",
	"SETTINGS_DIFFICULTY_MEDIUM": "Media",
	"SETTINGS_DIFFICULTY_HARD": "Difficile",
	...
	"SETTINGS_RESET_HINT": "Ripristina le impostazioni e i nomi predefiniti.",
	...
	"ACTION_HINT_TAP_TABLE": "Tocca lo schermo — turno successivo",
	"TIME_PROGRESS_LABEL": "Fino alla fine",
	"TIME_PROGRESS_MINUTES": "%d min",
	"HUD_LOTTERY": "Sorteggio — chi inizia?",
	"HUD_READY": "Pronti?",
	"HUD_START_ROUND": "Avvia round",
	"HUD_START_ROUND_HINT": "Tocca «Avvia round»",
	"HUD_TABLE_CENTER_HINT": "Metti il telefono al centro del tavolo",
