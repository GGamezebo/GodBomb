...
const RULES_TEXT := """[font_size=36]Весёлая словесная игра на одном телефоне или планшете: компания садится вокруг экрана, бомба идёт по кругу, а вы на ходу придумываете слова. Не успели — бум и штраф. Подойдёт и для двоих, и для большой тусовки.

[font_size=40][b]Как играть?[/b][/font_size]
На циферблате появляется слог — скажем, «ЛО» — и условие: слог в начале слова, в конце или где угодно.

Назовите подходящее слово вслух и передайте бомбу соседу — коротким нажатием на экран.

Лодка — полотно — весло — алоэ — ло… бум! Взрыв у того, кто держал бомбу: +1 штрафное очко.

Сначала жребий выбирает, кто начнёт. Потом «Готовы?», отсчёт — и раунд пошёл.

[font_size=40][b]Когда бум?[/b][/font_size]
Время до взрыва каждый раз разное — от почти мгновенного до долгой серии ходов. Перед концом бомба подаёт сигнал: успейте передать или готовьтесь к штрафу.

Между раундами на экране мелькает, сколько игры ещё впереди.

[font_size=40][b]Кто победил?[/b][/font_size]
После всех раундов смотрите таблицу: у кого меньше штрафов — тот выше. Лучше думать быстро, чем героически тянуть время с бомбой в руках.

[font_size=40][b]Сбор игроков[/b][/font_size]
Нужно минимум двое, максимум двенадцать. [b]+[/b] — новый игрок, перетащите слайм на другого — поменяйте места за столом, удержите ~1,5 с — имя и цвет.

В настройках задаёте длительность партии — от неё зависит число раундов.

[font_size=40][b]Если что-то пошло не так[/b][/font_size]
Неверное слово или случайное нажатие? В бою есть аварийная кнопка: выберите, кто переигрывает ход. Состав игроков можно поправить и прямо во время матча — через кнопку со списком за столом.
