...
const ROUNDS_FR: Array[Dictionary] = [
	...
	},
	{
		...
		"condition": WordCondition.Type.END,
		"word_hint": "manger",
		"examples": "manger, banque, chanson",
